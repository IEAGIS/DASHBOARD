...
*/		
	...
	/* create chart in the container element */
	$('#chartContainerGrowth').jqxChart(chartSettings);	
	...
	/* create chart in the container element */
	$('#chartContainerRate').jqxChart(chartSettings);
	}	
	...
	var stateInitPie = function(){
		...
		/* create chart in the container element */
		$('#chartContainerPie').jqxChart(chartSettings);		
	}
	...
	var selectReport = function(rpt){
		//switch(rpt){
			...
			//break;
		//}
		//$('#chartContainerGrowth').jqxChart('refresh');
	}
